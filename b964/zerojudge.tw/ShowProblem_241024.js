				...
				$.ajax({
					...
					success : function(data) {
						...
						$.each(data, function(key, val) {
							var new_serverOutput = modal_serveroutputs.find("div[id='ServerOutput']:last").clone();
							...
							new_serverOutput.insertAfter(modal_serveroutputs.find("div#ServerOutput:last"));
